...
{
	[Route("api/reminders")]
	public partial class ReminderController : Controller
	{
		...
		public IActionResult Update(Guid id, [FromBody] CreateReminderItemViewModel model)
		{
			...
			var exitstItem = _storage.FindById(id);
			if (exitstItem == default)
			{
				return NotFound();
			}
